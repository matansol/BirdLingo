...
# Load the bird data
with open('../data/birds_info.json', 'r', encoding='utf-8') as f:
...
# Save back to JSON
with open('../data/birds_info.json', 'w', encoding='utf-8') as f:
...
import shutil
shutil.copyfile('../data/birds_info.json', '../data/fetch_output.json')
import sys
import subprocess
try:
